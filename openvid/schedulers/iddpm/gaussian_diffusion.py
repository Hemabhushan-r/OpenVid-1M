...
class GaussianDiffusion:
    ...
    def __init__(self, *, betas, model_mean_type, model_var_type, loss_type, rbl):
        ...
        self.posterior_mean_coef1 = betas * \
            np.sqrt(self.alphas_cumprod_prev) / (1.0 - self.alphas_cumprod)
    ...
    def ddim_sample(
        ...
        mean_pred = out["pred_xstart"] * \
            th.sqrt(alpha_bar_prev) + th.sqrt(1 -
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None):
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            # print(
            #     f'Shapes model_output.shape {model_output.shape} target.shape {target.shape} x_start.shape {x_start.shape}')
